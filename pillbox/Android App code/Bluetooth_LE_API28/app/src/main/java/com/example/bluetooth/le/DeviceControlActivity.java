...
public class DeviceControlActivity extends Activity {
    ...
    private final ExpandableListView.OnChildClickListener servicesListClickListner =
            new ExpandableListView.OnChildClickListener() {
                @Override
                public boolean onChildClick(ExpandableListView parent, final View v, int groupPosition,
                    ...
                    if (mGattCharacteristics != null) {
                        ...
                        if ((charaProp & BluetoothGattCharacteristic.PROPERTY_WRITE) > 0) {
                            ...
                            // Set up the input
                            input = new EditText(DeviceControlActivity.this);
                            ...
                            builder.setNeutralButton("Read", new DialogInterface.OnClickListener() {
                                @Override
                                public void onClick(DialogInterface dialog, int which) {
                            ...
                            dialog.getButton(AlertDialog.BUTTON_NEUTRAL).setOnClickListener(new View.OnClickListener()
                            {
                                ...
                                public void onClick(View v)
                                {
                                    ...
                                    Log.d(TAG, "previous value is " + previousValue);
                                    Toast.makeText(DeviceControlActivity.this, previousValue, Toast.LENGTH_LONG).show();
                                }
                            });
                        }
                        return true;
